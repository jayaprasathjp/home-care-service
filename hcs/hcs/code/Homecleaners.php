...
<li><a href="about.php">about</a></li>
  ...
  <span >R</span>
      ...
      <h2 align='center' style='color:brown;' class='subhead'><b>The Homecleaners are the ones who bring cleanliness to our home and life</b></h2>
    </div>
     ...
     <script>
       function search(){
         ...
         var xmlhttp = new XMLHttpRequest();
           ...
           xmlhttp.open("GET", "searchhome.php?q=" + str, true);
           xmlhttp.send();
       }
     </script>
       ...
       $sql1="SELECT * FROM `worker` where `worker_cat`='4'";
      ...
      echo "<th colspan='8' style='border-bottom:solid 1px;'> <h3 align='center'><b>The Home cleaners  available</b></h3></th>";   
     echo '<div class="row"> ';
